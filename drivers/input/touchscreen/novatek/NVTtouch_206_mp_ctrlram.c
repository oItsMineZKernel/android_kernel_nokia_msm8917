...
static int32_t nvt_read_short_rxrx(void)
{
	...
	char *fbufp = NULL;
	mm_segment_t org_fs;
	char file_path[64]="/data/misc/touch/ShortTestRX-RX.csv";	//SW4-HL-TP-FixRunInFail-00*_20161201
	loff_t pos = 0;
	int32_t write_ret = 0;
...
static int32_t nvt_read_short_txrx(void)
{
	...
	char *fbufp = NULL;
	mm_segment_t org_fs;
	char file_path[64]="/data/misc/touch/ShortTestTX-RX.csv";	//SW4-HL-TP-FixRunInFail-00*_20161201
	loff_t pos = 0;
	int32_t write_ret = 0;
	uint32_t output_len = 0;
...
static int32_t nvt_read_short_txtx(void)
{
	...
	char *fbufp = NULL;
	mm_segment_t org_fs;
	char file_path[64]="/data/misc/touch/ShortTestTX-TX.csv";	//SW4-HL-TP-FixRunInFail-00*_20161201
	loff_t pos = 0;
	int32_t write_ret = 0;
	uint32_t output_len = 0;
...
static int32_t nvt_read_open(void)
{
	...
	char *fbufp = NULL;
	mm_segment_t org_fs;
	char file_path[64]="/data/misc/touch/OpenTest.csv";	//SW4-HL-TP-FixRunInFail-00*_20161201
	loff_t pos = 0;
	int32_t write_ret = 0;
	uint32_t output_len = 0;
...
static int nvt_extFIH_MP_show(struct seq_file *m, void *v) {
	...
	char *fbufp = NULL;
	mm_segment_t org_fs;
  	char file_path[64]="/data/misc/touch/D1_sensortest.txt";	//SW4-HL-TP-FixRunInFail-00*_20161201
...
static int nvt_extFIH_fwUpdate_singleOps(struct seq_file *m, void *v) {
	...
	if (ret) {
		...
		BBOX_TP_FIRMWARE_UPDATE_FAIL	//SW4-HL-TP-BBox-00+_20161221
		seq_printf(m, "%d\n",1);
		return 0;//return;
	}
...
void touch_fwupgrade_read_nvt(char *buf)
{
	...
	//SW4-HL-TP-FixFirmwareUpgradeFai-00-{_20161129
	#if 0
	ret = Check_CheckSum();
	if (ret != 1)
	{
