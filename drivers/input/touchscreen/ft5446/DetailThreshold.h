...
{
	unsigned char InvalidNode[TX_NUM_MAX][RX_NUM_MAX];//ÎÞÐ§½Úµã£¬¼´²»ÓÃ²âÊÔµÄ½Úµã
	unsigned char InvalidNode_SC[TX_NUM_MAX][RX_NUM_MAX];//ÎÞÐ§½Úµã£¬¼´²»ÓÃ²âÊÔµÄ½ÚµãSCAP
	...
	int SCapRawDataTest_ON_Max[TX_NUM_MAX][RX_NUM_MAX];//´ÓÕâ¿ªÊ¼¶¼ÊÇ×ÔÈÝµÄ²âÊÔÏî£¬»¥ÈÝ²âÊÔÏî±ØÐëÈ«²¿·ÅÔÚÉÏÃæ
...
struct stCfg_SCap_DetailThreshold
{
	...
	int DeltaCxTest_Sort[MAX_CHANNEL_NUM];         //Sort ¶Ô6x06Óë6x36Í¨ÓÃ
	int DeltaCxTest_Area[MAX_CHANNEL_NUM];         //Sort ¶Ô6x06Óë6x36Í¨ÓÃ
