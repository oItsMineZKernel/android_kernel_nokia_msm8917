...
void OnInit_DThreshold_RawDataTest(char *strIniFile)
{
	...
	//RawData Test Low
	MaxValue = g_stCfg_FT5X22_BasicThreshold.RawDataTest_Low_Max;
	for(i = 0; i < g_ScreenSetParam.iUsedMaxTxNum; i++)
	{
		for(j = 0; j < g_ScreenSetParam.iUsedMaxRxNum; j++)
		{
	...
	MinValue = g_stCfg_FT5X22_BasicThreshold.RawDataTest_low_Min;
	for(i = 0; i < g_ScreenSetParam.iUsedMaxTxNum; i++)
	{
		for(j = 0; j < g_ScreenSetParam.iUsedMaxRxNum; j++)
		{
	...
	//RawData Test High
	MaxValue = g_stCfg_FT5X22_BasicThreshold.RawDataTest_high_Max;
	for(i = 0; i < g_ScreenSetParam.iUsedMaxTxNum; i++)
	{
		for(j = 0; j < g_ScreenSetParam.iUsedMaxRxNum; j++)
		{
	...
	MinValue = g_stCfg_FT5X22_BasicThreshold.RawDataTest_high_Min;
	for(i = 0; i < g_ScreenSetParam.iUsedMaxTxNum; i++)
	{
		for(j = 0; j < g_ScreenSetParam.iUsedMaxRxNum; j++)
		{
...
void OnInit_DThreshold_SCapRawDataTest(char *strIniFile)
{
	...
	MaxValue = atoi(str);
	*/
	MinValue = g_stCfg_FT5X22_BasicThreshold.SCapRawDataTest_OFF_Min;
	MaxValue = g_stCfg_FT5X22_BasicThreshold.SCapRawDataTest_OFF_Max;
	///Max
	for(i = 0; i < 2; i++)
	{
		for(j = 0; j < g_ScreenSetParam.iUsedMaxRxNum; j++)
	...
	*/
	...
	MinValue = g_stCfg_FT5X22_BasicThreshold.SCapRawDataTest_ON_Min;
	MaxValue = g_stCfg_FT5X22_BasicThreshold.SCapRawDataTest_ON_Max;
...
void OnInit_DThreshold_SCapCbTest(char *strIniFile)
{
	...
	MaxValue = atoi(str);
	*/
	MinValue = g_stCfg_FT5X22_BasicThreshold.SCapCbTest_ON_Min;
	MaxValue = g_stCfg_FT5X22_BasicThreshold.SCapCbTest_ON_Max;
	///Max
	for(i = 0; i < 2; i++)
	{
		for(j = 0; j < g_ScreenSetParam.iUsedMaxRxNum; j++)
	...
	MaxValue = atoi(str);
	*/
	MinValue = g_stCfg_FT5X22_BasicThreshold.SCapCbTest_OFF_Min;
	MaxValue = g_stCfg_FT5X22_BasicThreshold.SCapCbTest_OFF_Max;
	///Max
	for(i = 0; i < 2; i++)
	{
		for(j = 0; j < g_ScreenSetParam.iUsedMaxRxNum; j++)
