...
extern int fts_ctpm_fw_upgrade_with_app_file_fih(struct i2c_client *client, char *firmware_name);
extern unsigned char fts_ctpm_get_app_file_ver(struct i2c_client *client, char *firmware_name);	//HL+_20151118
