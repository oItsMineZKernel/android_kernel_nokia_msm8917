...
#define STDebug 			0	
/*-----------------------------------------------------------
IC ¶ÔÓ¦Âë£¬Ã¿Ò»¿ÅIC´úÂëÊÇ8 bit£¬¸ßËÄÎ»´ú±íÏàÍ¬ÏµÁÐ£¬µÍËÄÎ»Çø±ð¾ßÌåIC
-----------------------------------------------------------*/
enum IC_Type//IC ¶ÔÓ¦Âë£¬Ã¿Ò»¿ÅIC´úÂëÊÇ8 bit£¬¸ßËÄÎ»´ú±íÏàÍ¬ÏµÁÐ£¬µÍËÄÎ»Çø±ð¾ßÌåIC
{
	IC_FT5X36 = 0x10,
	IC_FT5X36i = 0x11,
	IC_FT3X16 = 0x12,
...
extern struct StruScreenSeting g_ScreenSetParam; //ÆÁÄ»ÉèÖÃ²ÎÊý
