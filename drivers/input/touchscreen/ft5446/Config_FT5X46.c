...
* Created: 2015-11-26
*
* Abstract: Set Config for FT5X46\FT5X46i
*
************************************************************************/
...
void OnInit_FT5X22_TestItem(char *strIniFile)
{
	...
	/////////////////////////////////// Adc Detect Test
	GetPrivateProfileString("TestItem","ADC_DETECT_TEST","0",str,strIniFile);
	...
	/////////////////////////////////// SCAP_CB_TEST
	GetPrivateProfileString("TestItem","SCAP_CB_TEST","0",str,strIniFile);
	g_stCfg_FT5X22_TestItem.SCAP_CB_TEST = atoi(str);

	/////////////////////////////////// SCAP_RAWDATA_TEST
	GetPrivateProfileString("TestItem","SCAP_RAWDATA_TEST","0",str,strIniFile);
	g_stCfg_FT5X22_TestItem.SCAP_RAWDATA_TEST = atoi(str);

	/////////////////////////////////// CHANNEL_NUM_TEST
	GetPrivateProfileString("TestItem","CHANNEL_NUM_TEST","0",str,strIniFile);
...
void OnInit_FT5X22_BasicThreshold(char *strIniFile)
{
	...
	GetPrivateProfileString("Basic_Threshold","RawDataTest_Low_Min","1000",str,strIniFile);		//Modify to pass test until correct value is available	//SW4-HL-TouchPanel-FixToPassSelfTest-00*_20151225
	g_stCfg_FT5X22_BasicThreshold.RawDataTest_low_Min = atoi(str);
	GetPrivateProfileString("Basic_Threshold","RawDataTest_Low_Max","18500",str,strIniFile);	//Modify to pass test until correct value is available	//SW4-HL-TouchPanel-FixToPassSelfTest-00*_20151225
	g_stCfg_FT5X22_BasicThreshold.RawDataTest_Low_Max = atoi(str);

	GetPrivateProfileString("Basic_Threshold","RawDataTest_High_Min","1000",str,strIniFile);	//Modify to pass test until correct value is available	//SW4-HL-TouchPanel-FixToPassSelfTest-00*_20151225
	g_stCfg_FT5X22_BasicThreshold.RawDataTest_high_Min = atoi(str);
	GetPrivateProfileString("Basic_Threshold","RawDataTest_High_Max","18500",str,strIniFile);	//Modify to pass test until correct value is available	//SW4-HL-TouchPanel-FixToPassSelfTest-00*_20151225
	g_stCfg_FT5X22_BasicThreshold.RawDataTest_high_Max = atoi(str);

	GetPrivateProfileString("Basic_Threshold","RawDataTest_LowFreq","1",str,strIniFile);
	g_stCfg_FT5X22_BasicThreshold.RawDataTest_SetLowFreq  = atoi(str);
	GetPrivateProfileString("Basic_Threshold","RawDataTest_HighFreq","1",str,strIniFile);
