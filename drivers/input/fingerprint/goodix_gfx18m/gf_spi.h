...
struct gf_key_map
{
    char *name;
    unsigned short val;
    unsigned short key_customer1;//FihtdcCode@AlanHZ, Add for key define by customer
    unsigned short key_customer2;//FihtdcCode@AlanHZ, Add for key define by customer
};
