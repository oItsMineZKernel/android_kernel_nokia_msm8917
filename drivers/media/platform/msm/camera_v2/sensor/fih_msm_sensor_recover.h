//misty add for E2MP recover++
struct msm_camera_i2c_reg_array s5k4h7_recover[]=
{
//init setting
  {0x0100, 0x00, 0x00},
  {0x0B05, 0x01, 0x00},
...
//res0 setting
  ...
  {0x0203, 0x08, 0x00},
  {0x3400, 0x01, 0x00},
  {0x0101, 0x03, 0x00}, //FLIP_MIRROR, Don't forget when recover
  {0x0100, 0x01, 0x00}, //Streaming On,Don't forget when recover
};

//misty add for E2MP recover--

struct msm_camera_i2c_reg_array s5k3p3_recover[]=
{
//init setting
...
struct msm_camera_i2c_reg_array s5k4h8_recover[]=
{
//init setting
  {0x6028,0x2000,0x0},
  {0x602A,0x1FD0,0x0},
...
struct msm_camera_i2c_reg_array s5k3p3_ple_recover[]=
{
    //init setting
  {0x6028, 0x4000, 0x0000},
  {0x6010, 0x0001, 0x0bb8},
  ...
  {0x0114, 0x0300, 0x0000},
  {0x0110, 0x0002, 0x0000},
  {0x0136, 0x1900, 0x0000},
  {0x0304, 0x0006, 0x0000},
  {0x0306, 0x0086, 0x0000},
  {0x0302, 0x0001, 0x0000},
  {0x0300, 0x0004, 0x0000},
  {0x030C, 0x0004, 0x0000},
  {0x030E, 0x006F, 0x0000},
  {0x030A, 0x0001, 0x0000},
  {0x0308, 0x0008, 0x0000},
  {0x0342, 0x141C, 0x0000},
  {0x0340, 0x0E2A, 0x0000},
...
struct msm_camera_i2c_reg_array s5k4h8_ple_recover[]=
{
    //init setting
  {0x6028,0x2000,0x0},
  {0x602A,0x1FD0,0x0},
