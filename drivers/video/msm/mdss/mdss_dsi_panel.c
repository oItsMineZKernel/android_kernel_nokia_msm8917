...
//Sw4-HL-Display-FixCeCtNotWorkInAndroidO-FixedValueSinceNoUIForCeCtAlready-00+{_20171107
...
void fih_get_panel_status(struct mdss_dsi_ctrl_pdata *ctrl_pdata);//FIHTDC - gatycclu - MA3-589 - Show Driver IC status
...
static int old_bl_level = 0;	//SW4-HL-Display-ShowLCMAndBacklightStatus-00+_20160304
							...
							u32 bl_level)
{
	...
	//SW4-HL-Display-NotEnableBlIfLcmNotExist-00+{_20160628
...
static int mdss_dsi_panel_on(struct mdss_panel_data *pdata)
{
	...
	if (on_cmds->cmd_cnt)
	{
		//SW4-HL-Display-RotateImageOnlyForNB1Project+{_20160321
	...
	if(ctrl->panel_data.panel_info.pid == FIH_ILI7807E_1080P_VIDEO_PANEL)
	  fih_tp_lcm_resume();
    	else if(ctrl->panel_data.panel_info.pid == FIH_R61322_1080P_VIDEO_PANEL || ctrl->panel_data.panel_info.pid == FIH_PJ050IA_NT35521S_720P_VIDEO_PANEL)//SW8-DH-Merger-2006000-00*
...
//SW4-HL-Display-EnhanceErrorHandling-00*{_20150320
	return 0;
cmds_fail:
	BBOX_LCM_DISPLA_ON_FAIL //SW4-HL-Display-BBox-01+_20160804
	return res;
...
//SW4-HL-Display-EnhanceErrorHandling-00+{_20150320
cmds_fail:
	BBOX_LCM_DISPLA_OFF_FAIL	//SW4-HL-Display-BBox-01+_20160804
	return res;
//SW4-HL-Display-EnhanceErrorHandling-00+}_20150320
}
...
{
	char *rx_buf;		//FIHTDC - gatycclu - MA3-589 - Show Driver IC status
...
static int mdss_dsi_panel_ce_onoff_BeforeInit(struct mdss_dsi_ctrl_pdata *ctrl_pdata, unsigned long enable)
{
	...
	ce_status = enable;	//Sw4-HL-Display-FixCeCtNotWorkInAndroidO-FixedValueSinceNoUIForCeCtAlready-00+_20171107
